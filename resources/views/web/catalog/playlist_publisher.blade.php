                            ...
                            <div class="row row10px float-col-width">
                                ...
                                <div class="col">
                                    <div class="card card1">
                                        <div class="card-header" style="background-image: url({{$item['playlist_cover'] ? Helpers::file_path($item['playlist_id'], env('DATA_URL').MUSIC_PLAYLIST_PATH, true).$item['playlist_id'] . '.png?v=' . time() : '/imgs/avatar_default.png'}});">
