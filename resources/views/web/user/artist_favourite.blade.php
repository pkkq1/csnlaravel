            ...
            <li class="media align-items-stretch items-stretch-{{$item['artist']['artist_id']}}">
                ...
                <div class="media-left align-items-stretch mr-2">
                    <a href="{{$url}}" title="{{$item['artist']['artist_nickname']}}">
                        <img src="{{$item['artist']['artist_avatar'] ? env('DATA_URL').Helpers::file_path($item['artist']['artist_id'], AVATAR_ARTIST_THUMB_CROP_PATH, true) . $item['artist']['artist_avatar'] : env('IMG_DATA_URL').'imgs/no_cover.jpg'}}" alt="{{$item['artist']['artist_nickname']}}">
                    </a>
                </div>
