                                ...
                                @foreach($playlist as $key2 => $item)
                                    ...
                                    <div class="col">
                                        <div class="card card1">
                                            <div class="card-header" style="background-image: url({{$item->playlist_cover ? Helpers::file_path($item->playlist_id, PUBLIC_MUSIC_PLAYLIST_PATH, true).$item->playlist_id . '.jpg?v=' . time() : '/imgs/avatar_default.png'}});">
