...
@if($music->toArray()['data'])
                ...
                <div class="media-body">
                    <div class="body_commnet">
                        <div class="d-flex align-items-center justify-content-between">
                            <h5 class="media-title mt-0 mb-1"><a href="/user/{{$item['user_id']}}" title="{{$item['name']}}">{{$item['name']}}</a></h5>
                        </div>
    ...
    <center><?php echo str_replace(url()->current(), '/binh-luan-moi', $music->links()) ?></center>
@endif