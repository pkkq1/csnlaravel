            ...
            <div class="col-md-3 home-bxh">
                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <ul class="list-unstyled bxh mb-0">
                            ...
                            <li class="media {{($i == 1 ? 'first stand' : ($i == 2 ? 'now up' : ($i == 3 ? 'now down' : 'now')))}} align-items-stretch">
                                <div class="media-left mr-3">
                                    <span></span>
                                    <a href="{{$url}}" title="{{$item['music_title']}}"><img src="{{$item['cover_thumb_html']}}" alt="{{$item['music_title']}}">
                                        @if($item['cat_id'] == CAT_BEAT)
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <ul class="list-unstyled bxh mb-0">
                            <?php
                            $catMusic = array();//array_slice($hot_music_rows[4], 0, LIMIT_HOME_CAT_MUSIC);
                            array_map(function ($i, $item) {
                            $musicId = Helpers::music_id($item);
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                        <ul class="list-unstyled bxh mb-0">
                            <?php
                            $catMusic = array();//array_slice($hot_music_rows[6], 0, LIMIT_HOME_CAT_MUSIC);
                            array_map(function ($i, $item) {
                            $musicId = Helpers::music_id($item);
                    ...
                    <div class="tab-pane fade" id="jpop" role="tabpanel" aria-labelledby="jpop-tab">
                        <ul class="list-unstyled bxh mb-0">
                            <?php
                            $catMusic = array();//array_slice($hot_music_rows[7], 0, LIMIT_HOME_CAT_MUSIC);
                            array_map(function ($i, $item) {
                            $musicId = Helpers::music_id($item);
                ...
                <div class="singer_grid">
                    ...
                    array_map(function ($i, $item) {
                    ?>
                    <a href="{{$item['artist_url']}}" title="{{$item['music_artist']}}" class="img-thumbnail singer {{$i == 0 ? 'c1' : ''}}" style="background-image: url({{env('DATA_URL').($i == 0 ? $item['artist_avatar'] : $item['artist_avatar_thumb'])}});">
