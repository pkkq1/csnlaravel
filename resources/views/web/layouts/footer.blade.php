...
<script type="text/javascript">
    ...
    if ( screenW > 1024 )
    {
        ...
        document.write('<a target="_blank" href="https://clicktrackingv2.userreport.com/?BLV70dddb8e;http://yame.vn/?utm_source=Blueseed&utm_medium=CPD&utm_campaign=Background"><div id="bgsb_left" style="position: fixed; top: 150px; left: 0pt; width: 100%; height: ' + b_height + 'px; overflow: hidden; visibility: hidden;"><div style="position: absolute; visibility: visible; left: 50%; margin-left: -960px; margin-right: 0pt; z-index:-2;">');
        ...
        document.write('<a target="_blank" href="https://clicktrackingv2.userreport.com/?BLV70dddb8e;http://yame.vn/?utm_source=Blueseed&utm_medium=CPD&utm_campaign=Background"><div id="asb_left" style="position: fixed; top: 150px; left: 0pt; width: 100%; height: ' + b_height + 'px; overflow: hidden; visibility: hidden;"><div style="position: absolute; visibility: visible; left: 50%; margin-left: ' + b_marginleft + 'px; margin-right: 0pt; z-index:-1;">');
        document.write('<img src="http://chiasenhac.vn/banner/yame/Left.png" border="0" width="150" height="700" />');
        document.write('</div></div></a>');

        document.write('<a target="_blank" href="https://clicktrackingv2.userreport.com/?BLV70dddb8e;http://yame.vn/?utm_source=Blueseed&utm_medium=CPD&utm_campaign=Background"><div id="bgsb_right" style="position: fixed; top: 150px; right: 0pt; width: 100%; height: ' + b_height + 'px; overflow: hidden; visibility: hidden;"><div style="position: absolute; visibility: visible; left: 50%; margin-left: 500px; margin-right: 0pt; z-index:-2;">');
        document.write('<div style="width: 460px; height: 1000px; position: relative; background-color: #851c1c; background-repeat: no-repeat; background-position: center;"/> </div>');
        document.write('<img src="https://visitanalytics.userreport.com/hit.gif?t=BLV9eacb70a">');
        document.write('</div></a></div>');

        document.write('<a target="_blank" href="https://clicktrackingv2.userreport.com/?BLV70dddb8e;http://yame.vn/?utm_source=Blueseed&utm_medium=CPD&utm_campaign=Background"><div id="asb_right" style="position: fixed; top: 150px; right: 0px; width: 100%; height: ' + b_height + 'px; overflow: hidden; visibility: hidden;"><div style="position: absolute; visibility: visible; left: 50%; margin-left: 500px; margin-right: 0pt; z-index:-1;">');
