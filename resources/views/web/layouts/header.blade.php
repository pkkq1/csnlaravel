...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/node_modules/owl.carousel/dist/assets/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/node_modules/owl.carousel/dist/assets/owl.theme.default.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/assets/emoji-picker-master/lib/css/emoji.css">
    ...
    <link rel="stylesheet" href="{{env('APP_URL')}}/css/lobibox.min.css"/>
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/css/style.css">
    <link rel="stylesheet" type="text/css" href="{{env('APP_URL')}}/css/jquery-ui.css">
    ...
    <script type="text/javascript" src="{{env('APP_URL')}}/assets/jQuery-File-Upload-9.21.0/js/vendor/jquery.ui.widget.js"></script>
    <script type="text/javascript" src="{{env('APP_URL')}}/node_modules/bootstrap/dist/js/bootstrap.bundle.js"></script>
    {{--<script type="text/javascript" src="/node_modules/popper.js/dist/umd/popper.js"></script>--}}
    <script type="text/javascript" src="{{env('APP_URL')}}/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="{{env('APP_URL')}}/node_modules/owl.carousel/dist/owl.carousel.min.js"></script>
    ...
    <script type="text/javascript" src="{{env('APP_URL')}}/assets/emoji-picker-master/lib/js/util.js"></script>
    <script type="text/javascript" src="{{env('APP_URL')}}/assets/emoji-picker-master/lib/js/jquery.emojiarea.js"></script>
    <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <script src="{{env('APP_URL')}}/js/cookie.min.js"></script>
