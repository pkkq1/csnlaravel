                ...
                <div class="box">
                    ...
                    @if ($crud->model->translationEnabled())
                        <!-- Single button -->
                            ...
                            <h3 class="box-title" style="line-height: 30px;">Xem Góp Ý Của User: {{$fields['username']['value']}}</h3>
                        @else
                            <h3 class="box-title">Xem Góp Ý Của User: {{$fields['username']['value']}}</h3>
                        @endif
                    </div>
                                ...
                                foreach ($contentReport as $key => $item) {
                                    ...
                                    @if(key($item) == 'user')
                                        <div class="alert alert-primary" role="alert">
                                            <p style="white-space: pre-line; margin-top: -20px!important;">
