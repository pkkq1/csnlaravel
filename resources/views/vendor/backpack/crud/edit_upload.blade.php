                ...
                <div class="box">
                    ...
                    <div class="box-footer">
                        ...
                        <div id="saveActions" class="form-group">
                            ...
                            <a href="/admin/upload/set_exp/{{$fields['id']['value']}}" class="btn btn-warning" style="background-color: #000000; border-color: #171615;"><span class="fa fa-ban"></span> &nbsp;Chặn bài hát này</a>
                            <div class="btn-group">
