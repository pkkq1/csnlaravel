    ...
    <div class="container">
        <div class="media user11">
            <div class="media-left mr-4 align-self-center">
                <img id="view_user_avatar_2" src="{{(strpos(Auth::user()->user_avatar, 'http') !== false) ? Auth::user()->user_avatar : PUBLIC_AVATAR_PATH . Auth::user()->user_avatar}}" alt="{{Auth::user()->name}}" alt="">
            </div>
