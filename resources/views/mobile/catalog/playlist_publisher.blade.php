                                            ...
                                            <div class="row row-sm" id="album">
                                                ...
                                                <div class="col-6">
                                                    <div class="item element">
                                                        <a href="{{$url}}"><div style="background: url({{$item['playlist_cover'] ? Helpers::file_path($item['playlist_id'], env('DATA_URL').MUSIC_PLAYLIST_THUMB_200_PATH, true).$item['playlist_id'] . '.jpg?v=' . time() : '/imgs/avatar_default.png'}}) no-repeat center;background-size: cover;" class="image rounded"></div></a>
