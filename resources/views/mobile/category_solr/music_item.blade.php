...
<div class="element mb-2">
    <a href="{{$item['music_link'][0]}}"><div class="image100 mr-2 d-inline-block align-middle" style="background : url('{{$item['music_cover_thumb'][0]}}') no-repeat center;background-size: cover;"></div></a>
