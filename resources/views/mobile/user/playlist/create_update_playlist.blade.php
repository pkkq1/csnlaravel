                    ...
                    <div class="block block_album block_profile_playlist card_playlist">
                        <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="form-group row {{ $errors->has('playlist_cover') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    <div class="media">
                                        <img class="mr-3" style="width: 152px" id="playlist_cover_uploaded" src="{{$playlistUser ? ($playlistUser->playlist_cover ? Helpers::file_path($playlistUser->playlist_id, env('DATA_URL').MUSIC_PLAYLIST_PATH, true).$playlistUser->playlist_id . '.png?v=' . time() : env('IMG_DATA_URL').'imgs/avatar_default.png') : env('IMG_DATA_URL').'imgs/avatar_default.png' }}" alt="">
