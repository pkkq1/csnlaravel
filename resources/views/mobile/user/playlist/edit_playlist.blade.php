                            ...
                            <table class="table">
                                ...
                                @foreach($playlistUser as $item)
                                    ...
                                    <tr id="playlist_{{$item->playlist_id}}">
                                        ...
                                        <td>
                                            <div class="media">
                                                <a class="mr-3" href="{{$user}}" title="" style="display: contents;"><img style="width: 60px;" src="{{$item->playlist_cover ? Helpers::file_path($item->playlist_id, env('DATA_URL').MUSIC_PLAYLIST_PATH, true).$item->playlist_id . '.png?v=' . time() : env('IMG_DATA_URL').'imgs/avatar_default.png'}}" alt="{{$item->playlist_title}}"></a>
