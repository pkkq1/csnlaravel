...
@if($artistData['data'])
    ...
    <div class="element mb-2">
        <a href="{{$url}}"><div class="image100 mr-2 d-inline-block align-middle" style="background : url('{{$item['artist_avatar'] ? env('DATA_URL').Helpers::file_path($item['artist_id'], AVATAR_ARTIST_THUMB_CROP_PATH, true) . $item['artist_avatar'] : env('IMG_DATA_URL').'imgs/no_cover.jpg'}}') no-repeat center;background-size: cover;"></div></a>
