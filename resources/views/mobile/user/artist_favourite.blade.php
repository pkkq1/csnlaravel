...
@if($artistData['data'])
    ...
    <div class="element mb-2">
        <a href="{{$url}}"><div class="image100 mr-2 d-inline-block align-middle" style="background : url('{{$item['artist_cover'] ? PUBLIC_COVER_ARTIST_PATH.$item['artist_avatar'] : env('IMG_DATA_URL').'imgs/no_cover.jpg'}}') no-repeat center;background-size: cover;"></div></a>
