        ...
        <div class="box_avatar_profile">
            <div class="container">
                <div class="box_profile py-3">
                    <div class="box_profile__header"><a href="{{'/user/'.$user->id}}"><img id="view_user_avatar_2" class="view_user_avatar" src="<?php echo $avatar ?>" alt="{{$user->name}}"></a></div>
                </div>
                <div>
                                    ...
                                    @foreach($playlist as $key2 => $item)
                                        ...
                                        <div class="col-6">
                                            <div class="item element">
                                                ...
                                                <?php echo $tagHref ?><div style="background: url({{$item->playlist_cover ? Helpers::file_path($item->playlist_id, env('DATA_URL').MUSIC_PLAYLIST_THUMB_200_PATH, true).$item->playlist_id . '.jpg' : env('IMG_DATA_URL').'imgs/avatar_default.png'}}) no-repeat center;background-size: cover;" class="image rounded"></div></a>
            ...
            <div class="container py-3">
                ...
                <div class="box_profile pb-3">
                    <div class="box_profile__header"><a href="#" id="upload-avatar-crop">
                            <img id="view_user_avatar" src="<?php echo $avatar ?>" alt="{{$user->name}}">
                        </a></div>
