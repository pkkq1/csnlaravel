...
$thumnailMeta = '';
$music_lyric_karaoke = '';
$titleExMeta = $music->music_title.'; '.$music->music_artist . ' - ChiaSeNhac';
if($musicSet['type_listen'] == 'playlist') {
    $thumnailMeta = $musicSet['playlist']->playlist_cover;
    $titleExMeta = $musicSet['playlist']->playlist_title. ' - ChiaSeNhac';
} else {
                    ...
                    <div class="block_thongtin">
                        ...
                        @if ($auth_listen)
                            <div class="infor_main" style="min-height: 200px;">
                                @if (!$memberVip)
                                    <div style="text-align: right;"><a href="/chia-se-nhac-vip.html">[x Tắt quảng cáo]<?php echo ($memberVip ? 't' : 'f'); ?></a></div>
