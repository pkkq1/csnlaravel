        ...
        jwplayer("csnplayerads").setup({
            advertising: {
                ...
                "adschedule": {
                    "myPreroll": {
                        "offset": "pre",
                        "tag": ["https://delivery.yomedia.vn/vast?pid=cb3dd57d621d48669c11be66df3ec2f6&vast=3&ec=0&ref=[yo_page_url]&w=[player_width]&h=[player_height]&aaid=[yo_device_aaid]&idfa=[yo_device_idfa]"]
                    },
                    "myPreroll2": {
                        "offset": 1,
                        "tag": ["https://delivery.yomedia.vn/vast?pid=cb3dd57d621d48669c11be66df3ec2f6&vast=3&ec=0&ref=[yo_page_url]&w=[player_width]&h=[player_height]&aaid=[yo_device_aaid]&idfa=[yo_device_idfa]"]
