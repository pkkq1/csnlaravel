<div class="box_profile" style="padding: 0px!important;">
    <div class="container" style="position: relative;">
        <div style="position: relative;width: 100%">
            <img src="{{env('DATA_URL'). ($artist->artist_cover ? Helpers::file_path($artist->artist_id, $previewArtist ? CACHE_COVER_ARTIST_CROP_PATH : COVER_ARTIST_CROP_PATH, true).$artist->artist_cover : 'imgs/no_cover_artist.jpg')}}" style="width: 100%; height: 100%;" />
