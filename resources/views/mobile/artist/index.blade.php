...
@section('content')
    ...
    <main class="main main_profile">
        <section style="background: url('{{env('DATA_URL').  ($artist->artist_cover ?  Helpers::file_path($artist->artist_id, CACHE_COVER_ARTIST_CROP_PATH, true).$artist->artist_cover :'imgs/no_cover_artist.jpg')}}'); background-position: center; background-repeat: no-repeat;" class="block_banner_singer">
