        ...
        if(isset($cat_id2info[$music_info['cat_id']][$music_info['cat_level']])) {
            if ( ENV('APP_ENV') == 'beta đóng' ) { /// đóng lại khi sử dụng nhiều domain
                ...
                switch ($music_info['cat_id']) {
                    case 1:
                        $seo_domain = 'http://mv.chiasenhac.vn/';
                        break;
                    case 2:
                        $seo_domain = 'http://pb.chiasenhac.vn/';
                        break;
                    case 3:
                        $seo_domain = 'http://vn.chiasenhac.vn/';
                        break;
                    case 4:
                        $seo_domain = 'http://us.chiasenhac.vn/';
                        break;
                    case 5:
                        $seo_domain = 'http://cn.chiasenhac.vn/';
                        break;
                    case 6:
                        $seo_domain = 'http://kr.chiasenhac.vn/';
                        break;
                    case 7:
                        $seo_domain = 'http://jp.chiasenhac.vn/';
                        break;
                    case 8:
                        $seo_domain = 'http://fr.chiasenhac.vn/';
                        break;
                    case 9:
                        $seo_domain = 'http://ot.chiasenhac.vn/';
                        break;
                    default:
                        $seo_domain = '';
                }
...
//    }
    ...
    public static function album_url($album_info, $id = 0, $domain = '')
    {
    ...
    public static function domain_hosted($music_info)
    {
        ...
        if ($music_id < 1000000)
            $url = 'http://data50.chiasenhac.com/'; //'http://data3.chiasenhac.com/';
        else if ($music_id <= 1029000)
            $url = 'http://data51.chiasenhac.com/';
        else if ($music_id <= 1059000)
            $url = 'http://data52.chiasenhac.com/';
        else if ($music_id <= 1089000)
            $url = 'http://data53.chiasenhac.com/';
        else if ($music_id <= 1119000)
            $url = 'http://data54.chiasenhac.com/';
        else if ($music_id <= 1149000)
            $url = 'http://data55.chiasenhac.com/';
        else if ($music_id <= 1179000)
            $url = 'http://data56.chiasenhac.com/';
        else if ($music_id <= 1209000)
            $url = 'http://data57.chiasenhac.com/';
        else if ($music_id <= 1239000)
            $url = 'http://data58.chiasenhac.com/';
        else if ($music_id <= 1269000)
            $url = 'http://data59.chiasenhac.com/';
        else if ($music_id <= 1299000)
            $url = 'http://data60.chiasenhac.com/';
        else if ($music_id <= 1329000)
            $url = 'http://data61.chiasenhac.com/';
        else if ($music_id <= 1349000)
            $url = 'http://data62.chiasenhac.com/';
...
//        else if ($music_id <= 1489000)
//            $url = 'http://data.chiasenhac.com/dataxx/27/'; //'http://data27.chiasenhac.com/';
        // YCH's Server
            ...
            $url = 'http://data03.chiasenhac.com/'; // HDD ERROR DELETED
        // Large Server
...
//        }
    ...
    public static function file_url(&$music_info)
    {
        ...
        if ($url == 'http://data25.chiasenhac.com/') {
            $folder1 = 'download2/';
            $folder2 = 'stream2/';
        }
        else if ($url == 'http://data2.chiasenhac.com/') {
            $folder1 = 'stream2/';
            $folder2 = 'stream2/';
        }
        else if ($url == 'http://data.chiasenhac.com/') {
            $folder1 = 'down2/';
            $folder2 = 'down2/';
        }
        else {
        ...
        //$folder = ( $url == 'http://data25.chiasenhac.com/' ) ? 'stream2/' : 'downloads/';
        ...
        if ($music_info['music_extension'] == 'mp4') {
            ...
            if ($music_info['music_32_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder1 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/32/" . rawurlencode($music_info['music_file_cache']) . "." . $music_info['music_extension'],
                    'label' => '180p',
            ...
            if ($music_info['music_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder1 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/128/" . rawurlencode($music_info['music_file_cache']) . "." . $music_info['music_extension'],
                    'label' => '360p',
            ...
            if ($music_info['music_320_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder2 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/320/" . rawurlencode($music_info['music_file_cache']) . "." . $music_info['music_extension'],
                    'label' => '480p',
            ...
            if ($music_info['music_m4a_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder2 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/m4a/" . rawurlencode($music_info['music_file_cache']) . "." . $music_info['music_extension'],
                    'label' => '720p',
            ...
            if ($music_info['music_lossless_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder2 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/flac/" . rawurlencode($music_info['music_file_cache']) . "." . $music_info['music_extension'],
                    'label' => '1080p',
            ...
            if ($music_info['music_32_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder1 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/32/" . rawurlencode($music_info['music_file_cache']) . ".m4a",
                    'label' => '32kbps',
                    'size' => self::filesize2str($music_info['music_32_filesize']),
                    'type' => 'm4a'
                );
            ...
            if ($music_info['music_m4a_filesize'] > 0) {
                $file_url[] = array(
                    'url' => $url . $folder2 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/m4a/" . rawurlencode($music_info['music_file_cache']) . ".m4a",
                    'label' => '500kbps',
                    'size' => self::filesize2str($music_info['music_m4a_filesize']),
                    'type' => 'm4a'
                );
            ...
            if ($music_info['music_lossless_filesize'] > 0) {
                ...
                $file_url[] = array(
                    'url' => $url . $folder2 . ceil($music_id / 1000) . '/' . date('w') . '/' . rawurlencode($music_info['music_filename_noext']) . "/flac/" . rawurlencode($music_info['music_file_cache']) . ".flac",
                    'label' => 'Lossless',
                    'size' => self::filesize2str($music_info['music_lossless_filesize']),
                    'type' => 'flac'
                );
...
//        dd($lyrics);
    ...
    public static function pathAvatar($userAvatar, $userId, $domain = '') {
        if(!$userAvatar)
            return $domain.'imgs/no_avatar_thumb.jpg';
//        return (strpos($userAvatar, 'http') !== false) ? $userAvatar : $domain.Helpers::file_path($userId, ($domain ? AVATAR_PATH : PUBLIC_AVATAR_PATH), true) . $userAvatar;
        return $domain.Helpers::file_path($userId, ($domain ? AVATAR_PATH : PUBLIC_AVATAR_PATH), true) . ((strpos($userAvatar, 'http') !== false) ? $userId.'.jpg' : $userAvatar);
    }
...
//    return (strpos($userAvatar, 'http') !== false) ? $userAvatar : $domain.Helpers::file_path($userId, ($domain ? AVATAR_THUMB_PATH : PUBLIC_AVATAR_PATH), true) . $userAvatar;
    ...
    public static function getImgQuality($musicId) {
        return 'http://data50.chiasenhac.com/data/spectrum'.Helpers::file_path($musicId, '/', true).$musicId.'.jpg';
...
//    }
    public static function Dot2LongIP($IPaddr)
    {
        if ($IPaddr == "") {
            ...
            $ips = explode(".", $IPaddr);
            return (isset($ips[3]) && !isset($ips[4])) ? ($ips[3] + $ips[2] * 256 + $ips[1] * 256 * 256 + intval($ips[0]) * 256 * 256 * 256) : 0;
        }
    }
    public static function isVNIP($client_ip = '')
    {
        ...
        if ( $client_ip == '127.0.0.1' || $client_ip == '::1' ) return true; // localhost
