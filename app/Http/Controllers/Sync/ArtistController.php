        ...
        foreach ($top_artist_rows as $key => $item) {
            ...
            if($artist) {
                $result[] = [
                    ...
                    'artist_avatar' => $artist->artist_avatar ? Helpers::file_path($artist->artist_id, PUBLIC_AVATAR_ARTIST_PATH, true).$artist->artist_avatar : env('IMG_DATA_URL').'imgs/no_cover.jpg',
                    'artist_cover' => $artist->artist_cover ? Helpers::file_path($artist->artist_id, PUBLIC_COVER_ARTIST_PATH, true).$artist->artist_cover : env('IMG_DATA_URL').'imgs/no_cover_artist.jpg',
