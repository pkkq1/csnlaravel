...
class SolrSyncController extends Controller
{
    ...
    public function syncMusic($id = null, $musicItem = null, $time = null, $field = 'music_last_update_time', $offset = 0, $limit = 0)
    {
        $searchMusic = [];
        if ($id) {
                $searchMusic = MusicModel::select('music_id', 'music_composer', 'music_title', 'music_artist', 'music_downloads_this_week', 'music_search_result', 'music_time', 'music_last_update_time',
...
//        <delete><query>(id:music_*)AND(_version_:[0 TO 1627700530459443201])</query></delete>
        ...
        if ($id) {
            $searchMusic = MusicModel::select('music_id', 'music_composer', 'music_title', 'music_artist', 'music_downloads_this_week', 'music_search_result', 'music_time',
    ...
    function syncVideo($id = null, $videoItem = null, $time = null, $field = 'music_last_update_time', $offset = 0, $limit = 0)
    {
        ...
        if ($id) {
            if ($id < 1387001 or $id > 1419000) {
                $searchVideo = VideoModel::select('music_id', 'music_artist_search', 'music_composer', 'music_album_search', 'music_title', 'music_artist', 'music_downloads_this_week', 'music_search_result',
