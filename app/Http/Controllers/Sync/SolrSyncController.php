...
//                'video_title_artist_charset' => $titleCharset .' '. $artistCharset,
                ...
                'cover_id' => $item->cover_id,
                'video_bitrate_' => $item->music_bitrate,
                'video_length_' => $item->music_length,
                'video_length' => $item->music_length >= 3600 ? gmdate("H:i:s", $item->music_length) : gmdate("i:s", $item->music_length),
