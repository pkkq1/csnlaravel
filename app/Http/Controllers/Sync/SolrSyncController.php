...
//                'music_lyric_search' => $lyricSearch,
                ...
                'music_artist_id' => explode(';', htmlspecialchars_decode_decode($item->music_artist_id)),
...
//                'video_title_artist_charset' => $titleCharset .' '. $artistCharset,
                ...
                'video_artist_id' => explode(';', htmlspecialchars_decode_decode($item->music_artist_id)),//$item->music_artist_id, //str_replace(';', ',', $item->music_artist_id),
...
//                $artistCharset = Helpers::rawTiengVietUrl($music_artist, ' ');
                ...
                $data['album_music_artist_id'] = explode(';', htmlspecialchars_decode_decode($music_artist_id));
