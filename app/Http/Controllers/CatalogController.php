...
class CatalogController extends Controller
{
    ...
    public function musicNews(Request $request) {
        $music = $this->musicRepository->musicNews('music_id', 'desc', LIMIT_MUSIC_PAGE_CATEGORY);
    ...
    public function videoNews(Request $request) {
        $video = $this->videoRepository->videoNews('music_id', 'desc', LIMIT_MUSIC_PAGE_CATEGORY);
        if($request->input('tab'))
