...
class LyricKaraokeMusicController extends CrudController
{
    ...
    public function setup()
    {
        ...
        $this->crud->setEntityNameStrings('Danh Sách Karaoke', 'Danh Sách Nhạc Lyric Karaoke');
        $this->crud->setRoute(config('backpack.base.route_prefix').'/list_music_lyric_karaoke');
