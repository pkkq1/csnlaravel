...
class UploadExceptionModel extends Model
{
    ...
    protected $fillable = ['music_id', 'cat_id', 'cat_level', 'cat_sublevel', 'cover_id', 'music_title', 'music_artist', 'music_artist_id', 'music_composer', 'music_album', 'music_production', 'music_album_id', 'music_track_id', 'music_year', 'music_code_1', 'music_code_2',
