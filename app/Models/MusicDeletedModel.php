...
class MusicDeletedModel extends Model
{
    use CrudTrait;
    public $timestamps = false;
    protected $table = 'csn_music_deleted';
    protected $primaryKey = 'music_id';
    protected $fillable =
        [
            'music_id' ,'cat_id', 'cat_level', 'cat_sublevel', 'cover_id', 'music_download_time', 'music_last_update_time', 'music_title_url', 'music_title', 'music_artist', 'music_artist_id', 'music_composer', 'music_album', 'music_production', 'music_album_id', 'music_track_id', 'music_year',
            ...
            'music_bitrate_fixed_by', 'music_lyric', 'music_note', 'music_deleted', 'music_dmca', 'music_download_ip', 'music_comment', 'music_delete_time', 'music_search_result', 'music_m4a_file_size', 'music_lossless_filesize'
        ];
