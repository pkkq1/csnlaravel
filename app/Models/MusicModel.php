...
class MusicModel extends Model
{
    ...
    protected $fillable =
        [
            ...
            'music_bitrate_fixed_by', 'music_lyric', 'music_note', 'music_deleted', 'music_dmca', 'music_download_ip', 'music_comment', 'music_listen_time', 'music_new_id', 'music_m4a_filesize', 'music_lossless_filesize'
        ];
