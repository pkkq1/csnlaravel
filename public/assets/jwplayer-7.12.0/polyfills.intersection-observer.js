        ...
        ! function(t, e) {
            ...
            function n(t) {
                ...
                var e = this.boundingClientRect,
                    ...
                    i = o.width * o.height;
                this.intersectionRatio = n ? i / n : 0
            }
            ...
            if (!("IntersectionObserver" in t && "IntersectionObserverEntry" in t && "intersectionRatio" in t.IntersectionObserverEntry.prototype)) {
                ...
                o.prototype.THROTTLE_TIMEOUT = 100, o.prototype.POLL_INTERVAL = null, o.prototype.observe = function(t) {
                    ...
                    this._observationTargets.forEach(function(o) {
                        ...
                        t && h ? this._hasCrossedThreshold(c, l) && this._queuedEntries.push(l) : c && c.isIntersecting && this._queuedEntries.push(l)
                    }, this), this._queuedEntries.length && this._callback(this.takeRecords(), this)
                }, o.prototype._computeTargetAndRootIntersection = function(e, n) {
                    if ("none" != t.getComputedStyle(e).display) {
                        for (var o = a(e), i = o, r = e.parentNode, s = !1; !s;) {
                            var h = null;
                            if (r == this.root || 1 != r.nodeType ? (s = !0, h = n) : "visible" != t.getComputedStyle(r).overflow && (h = a(r)), h && (i = c(h, i), !i)) break;
                            r = r.parentNode
                        }
                        return i
                    }
                    ...
                    return !this.root || l.contains(this.root)
                }, o.prototype._rootContainsTarget = function(t) {
                    return (this.root || l).contains(t)
