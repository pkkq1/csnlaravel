    ...
    58: function(t, e, i) {
        ...
        r = [], n = function() {
            ...
            function r(t, i) {
                ...
                for (var h, l = t.document.createElement("div"), c = l, p = []; null !== (h = r());)
                    if ("<" !== h[0]) c.appendChild(t.document.createTextNode(o(h)));
                    else {
                        if ("/" === h[1]) {
                            p.length && p[p.length - 1] === h.substr(2).replace(">", "") && (p.pop(), c = c.parentNode);
                            continue
                        }
                        var u, f = e(h.substr(1, h.length - 2));
                        if (f) {
                            u = t.document.createProcessingInstruction("timestamp", f), c.appendChild(u);
                            continue
                        }
                        var d = h.match(/^<([^.\s\/0-9>]+)(\.[^\s\\>]+)?([^>\\]+)?(\\?)>?$/);
                        if (!d) continue;
                        if (u = s(d[1], d[3]), !u) continue;
                        if (!a(c, u)) continue;
                        d[2] && (u.className = d[2].substr(1).replace(".", " ")), p.push(d[1]), c.appendChild(u), c = u
                    }
                return l
            }
            ...
            function a(t) {
                ...
                return "ruby" === e.tagName ? a(t) : e.childNodes ? (o(t, e), a(t)) : void 0
            }
            ...
            function s(t) {
                ...
                for (o(r, t); e = a(r);)
                    for (var s = 0; s < e.length; s++)
                        if (i = e.charCodeAt(s), n(i)) return "rtl";
                return "ltr"
            }
            ...
            function c(t, e) {
                l.call(this), this.cue = e, this.cueDiv = r(t, e.text), this.cueDiv.className = "jw-text-track-cue jw-reset";
                var i = {
                    textShadow: "",
                    position: "relative",
                    left: 0,
            ...
            function u(t, e, i, r, n) {
                function o(t, e) {
                    for (var n, o = new p(t), a = 1, s = 0; s < e.length; s++) {
                ...
                if (s.snapToLines) {
                    ...
                    var f = a.lineHeight,
                        d = Math.floor(i[u] / f);
                    l = Math.min(l, d - n);
                    var g = f * Math.round(l),
                        m = i[u] + f,
                        v = c[0];
                    if (Math.abs(g) > m && (g = g < 0 ? -1 : 1, g *= Math.ceil(m / f) * f), l < 0) {
                        g += "" === s.vertical ? i.height : i.width;
                        var y = n * f;
                        g -= y, c = c.reverse()
                    }
                    g -= n, a.move(v, g)
                } else {
                    var b = a.lineHeight / i.height * 100;
                    switch (s.lineAlign) {
                        case "middle":
                            l -= b / 2;
                            break;
            ...
            t.prototype = Object.create(Error.prototype), t.prototype.constructor = t, t.Errors = {
                BadSignature: {
                    code: 0,
                ...
                percent: function(t, e) {
                    return !!(/^[\d]{1,3}(\.[\d]*)?%$/.test(e) && (e = parseFloat(e), e >= 0 && e <= 100)) && (this.set(t, e), !0)
                }
            };
            var g = {
                    "&amp;": "&",
            ...
            l.prototype.applyStyles = function(t, e) {
                ...
                return 0 === t ? 0 : t + e
            }, c.prototype = Object.create(l.prototype), c.prototype.constructor = c, p.prototype.move = function(t, e) {
            ...
            var w = "1.5%";
            f.processCues = function(t, e, i, r) {
                if (!t || !e || !i) return null;
                for (; i.firstChild;) i.removeChild(i.firstChild);
                if (!e.length) return null;
                var n = t.document.createElement("div");
                if (n.className = "jw-text-track-container jw-reset", n.style.position = "absolute", n.style.left = "0", n.style.right = "0", n.style.top = "0", n.style.bottom = "0", n.style.margin = w, i.appendChild(n), d(e) || r) {
                    var o = [],
                    ...
                    ! function() {
                        for (var i = 0; i < e.length; i++) {
                            var r = e[i],
                                h = new c(t, r);
                            h.div.className = "jw-text-track-display jw-reset", n.appendChild(h.div), u(t, h, a, o, s), s -= r.text.split("\n").length, r.displayState = h.div, o.push(p.getSimpleBoxPosition(h))
                        }
                    }()
                } else
                    for (var h = 0; h < e.length; h++) n.appendChild(e[h].displayState)
            }, window.WebVTT || (window.WebVTT = f)
