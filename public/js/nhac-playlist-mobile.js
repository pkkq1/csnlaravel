    ...
    J().registerPlugin("nhac", "6.0", function(e, w, C) {
        function J() {
            if (void 0 == w.showAutoNext || w.showAutoNext) {
                ...
                void 0 != a && (void 0 == PP && (PP = document.createElement("div"), PP.className = notClassRepeat, PP.innerHTML = notRepeat, $(PP).bind('touchstart', function(){
                ...
                }), a.parentNode.insertBefore(PP, a)), void 0 == PPP && (PPP = document.createElement("div"), PPP.className = "jw-icon csn-random-btn jw-icon-inline jw-button-color jw-reset jw-icon-sequence", PPP.innerHTML = sequence, PPP.title = "Ngẫu nhiên", $(PPP).bind('touchstart', function(){
