        ...
        function J() {
            if (void 0 == w.showAutoNext || w.showAutoNext) {
                if (void 0 == D) {
                    ...
                    void 0 != a && (D = document.createElement("div"), D.className = "jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-auto-next jw-icon-auto-next-on", D.title = "Tự Động Chuyển Bài", D.onclick = function() {
                ...
                void 0 != a && (void 0 == PP && (PP = document.createElement("div"), PP.className = "jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-repeat-all", PP.innerHTML = notRepeat, PP.title = "Không Lặp", PP.onclick = function () {
                    ...
                    "jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-sequence" == PPP.className ? (PPP.className = "jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-shuffle",
                        TTT = !1, PPP.innerHTML = shuffle, autoRandom(true)) : (PPP.className = "jw-icon jw-icon-inline jw-button-color jw-reset jw-icon-sequence", TTT = !0, PPP.innerHTML = sequence, autoRandom(false))
                }, a.parentNode.insertBefore(PPP, a)));
                if(sessionStorage.getItem("auto_repeat") == 'true') {
                    jwplayer().setConfig({
                        repeat: true
                    });
