        ...
        class RabbitLyrics {
                ...
                for (let i = 0; i < lines.length; i++) {
                    ...
                    if(contentLyric) {
                        ...
                        if (beginningTimeStamp.length > 0) {
                            ...
                            lineElement.dataset.start = firstDecodeTime;
                            karaElement.dataset.start = firstDecodeTime;
                            if(beforeNullContent) {
                                if((firstDecodeTime - beforeNullContent) > 3) {
                                    lineElement.dataset.start = firstDecodeTime - 3;
                                }else{
                                    lineElement.dataset.start = beforeNullContent;
                                }
                                // reset before timing
                                beforeNullContent = 0;
                            }
                        ...
                        beforeNullContent = firstDecodeTime;
                    }
                }
            ...
            synchronizer() {
                ...
                this.lineElements.forEach(element => {
                    ...
                    // let notEleActive = $('#lyrics').find('.line').not('.active').find('.kara-csn');
                });
